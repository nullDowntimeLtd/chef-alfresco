...
default['alfresco']['repo_tomcat_instance']['port'] = 807_0
default['alfresco']['repo_tomcat_instance']['shutdown_port'] = 800_5
default['alfresco']['repo_tomcat_instance']['jmx_port'] = 400_00
...
default['alfresco']['share_tomcat_instance']['port'] = 808_1
default['alfresco']['share_tomcat_instance']['shutdown_port'] = 801_5
default['alfresco']['share_tomcat_instance']['jmx_port'] = 400_10
...
default['alfresco']['solr_tomcat_instance']['port'] = 809_0
default['alfresco']['solr_tomcat_instance']['shutdown_port'] = 802_5
default['alfresco']['solr_tomcat_instance']['jmx_port'] = 400_20
...
default['alfresco']['activiti_tomcat_instance']['port'] = 806_0
default['alfresco']['activiti_tomcat_instance']['shutdown_port'] = 803_5
default['alfresco']['activiti_tomcat_instance']['jmx_port'] = 400_30
