...
node.set['alfresco']['properties']['db.pool.evict.interval'] = 900_000
node.set['alfresco']['properties']['db.pool.evict.idle.min'] = 180_000_0
...
default['alfresco']['properties']['monitor.rmi.services.port']  = 505_08
